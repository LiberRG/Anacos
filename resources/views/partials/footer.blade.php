<footer class="bg-azul-claro relative" x-data="footer()">
    ...
    <div x-cloak class="bg-azul-claro/[0.9] font-normal absolute right-0 bottom-14 w-full text-start z-10 ">
