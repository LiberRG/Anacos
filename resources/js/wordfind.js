...
//             t = {
//                 horizontal: function (n, r, t) { return { x: n + t, y: r } },
//                 horizontalBack: function (n, r, t) { return { x: n - t, y: r } },
//                 vertical: function (n, r, t) { return { x: n, y: r + t } },
//                 verticalUp: function (n, r, t) { return { x: n, y: r - t } },
//                 diagonal: function (n, r, t) { return { x: n + t, y: r + t } },
//                 diagonalBack: function (n, r, t) { return { x: n - t, y: r + t } },
//                 diagonalUp: function (n, r, t) { return { x: n + t, y: r - t } }, diagonalUpBack: function (n, r, t) { return { x: n - t, y: r - t } }
//             },
//             o = {
//                 horizontal: function (n, r, t, o, e) { return o >= n + e }, horizontalBack: function (n, r, t, o, e) { return n + 1 >= e },
//                 vertical: function (n, r, t, o, e) { return t >= r + e },
//                 verticalUp: function (n, r, t, o, e) { return r + 1 >= e },
//                 diagonal: function (n, r, t, o, e) { return o >= n + e && t >= r + e },
//                 diagonalBack: function (n, r, t, o, e) { return n + 1 >= e && t >= r + e },
//                 diagonalUp: function (n, r, t, o, e) { return o >= n + e && r + 1 >= e },
//                 diagonalUpBack: function (n, r, t, o, e) { return n + 1 >= e && r + 1 >= e }
//             },
//             e = {
//                 horizontal: function (n, r, t) { return { x: 0, y: r + 1 } },
//                 horizontalBack: function (n, r, t) { return { x: t - 1, y: r } },
//                 vertical: function (n, r, t) { return { x: 0, y: r + 100 } },
//                 verticalUp: function (n, r, t) { return { x: 0, y: t - 1 } },
//                 diagonal: function (n, r, t) { return { x: 0, y: r + 1 } },
//                 diagonalBack: function (n, r, t) { return { x: t - 1, y: n >= t - 1 ? r + 1 : r } },
//                 diagonalUp: function (n, r, t) { return { x: 0, y: t - 1 > r ? t - 1 : r + 1 } },
//                 diagonalUpBack: function (n, r, t) { return { x: t - 1, y: n >= t - 1 ? r + 1 : r } }
//             },
//             i = function (n, r) {
//                 var t, o, e, i = [];
//                 for (t = 0; t < r.height; t++)for (
//                     i.push([]),
//                     o = 0;
//                     o < r.width;
//                     o++)i[t].push("");
//                 for (t = 0, e = n.length; e > t; t++)
//                     if (!a(i, r, n[t])) return null; return i
//             },
//             a = function (n, r, o) {
//                 var e = l(n, r, o);
...
//             },
//             l = function (n, r, i) {
//                 for (var a = [], l = r.height, c = r.width, h = i.length, g = 0,
//                     v = 0,
//                     p = r.orientations.length;
//                     p > v; v++)
//                     for (var d = r.orientations[v], s = o[d], x = t[d], y = e[d], k = 0, B = 0;
//                         l > B;)
//                         if (s(k, B, l, c, h)) {
//                             var w = u(i, n, k, B, x);
//                             (w >= g || !r.preferOverlap && w > -1) && (g = w,
//                                 a.push({ x: k, y: B, orientation: d, overlap: w })),
//                                 k++,
//                                 k >= c && (k = 0, B++)
//                         } else {
//                             var U = y(k, B, h);
...
//             },
//             f = function (n, r) {
//                 for (var t = [], o = 0, e = n.length;
//                     e > o; o++)n[o].overlap >= r && t.push(n[o]); return t
//             },
//             c = function (n, r, t, o, e) {
//                 for (var i = 0, a = r.length; a > i; i++) {
//                     var l = e(t, o, i); n[l.y][l.x] = r[i]
//                 }
//             };
//         return {
//             validOrientations: r, orientations: t,
//             newPuzzle: function (n, t) {
//                 var o, e, a = 0, l = t || {}; o = n.slice(0).sort(function (n, r) {
//                     return n.length < r.length ? 1 : 0
//                 });
//                 for (var u = {
//                     height: l.height || o[0].length, width: l.width || o[0].length, orientations: l.orientations || r, fillBlanks: void 0 !== l.fillBlanks ? l.fillBlanks : !0, maxAttempts: l.maxAttempts || 3, preferOverlap: void 0 !== l.preferOverlap ? l.preferOverlap : !0
//                 };
//                     !e;
//                 ) {
...
//                 for (var t = 0, o = r.length; o > t; t++)for (var e = r[t], i = 0, a = e.length; a > i; i++)if (!r[t][i]) {
//                     var l = Math.floor(Math.random() * n.length);
//                     r[t][i] = n[l]
//                 }
//             }, solve: function (n, t) {
//                 for (var o = {
//                     height: n.length, width: n[0].length, orientations: r, preferOverlap: !0
//                 }, e = [], i = [], a = 0, u = t.length; u > a;
//                     a++) {
//                     var f = t[a], c = l(n, o, f);
